              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    SquareProfileCard(
                      onTap: () {
                        openUrl('https://skyonline-plus.com/police/directions.php');
                      },
                    ...
                    SquareProfileCard(
                      onTap: () {
                        openWhatsApp('201013037649'); // Ensure the correct phone number format
                      },
                ...
                ProfileCardWidget(
                  ontap: () {
                    openUrl('https://skyonline-plus.com/police/about-us.php');
